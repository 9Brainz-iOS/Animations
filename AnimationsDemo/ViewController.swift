...
private let arr: [Type] = [ .fadeColor,.fadeIn, .fadeOut, .popIn, .popOut, .slideInFromTop, .slideInFromBottom, .slideInFromLeft, .slideInFromRight, .slideOutToTop, .slideOutToBottom, .slideOutToLeft, .slideOutToRight, .bounceInFromTop, .bounceInFromBottom, .bounceInFromLeft, .bounceInFromRight, .bounceOutToTop, .bounceOutToBottom, .bounceOutToLeft, .bounceOutToRight, .shake, .shakeTowardLeft, .shakeTowardTop, .hop, .hopTowardTop, .hopTowardBottom, .hopTowardLeft, .hopTowardRight ]
...
class ViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
  ...
  @IBAction func startButtonPressed(_ sender: AnyObject) {
    startAnimation(arr[typePicker.selectedRow(inComponent: 0)])
  }
  ...
  private func startAnimation(_ type: Type) {
